...
Removed KDE Discover — it failed to launch reliably and is a software center, not an
update tool
...
Raptor Update Center — a native GTK4 GUI app for updating Raptor OS without using
the terminal; runs ujust update under the hood, streams live output, and offers a
one-click reboot when done; accessible from the app menu under System
