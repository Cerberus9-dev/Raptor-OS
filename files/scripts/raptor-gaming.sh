...
*    soft    nofile    1048576
*    hard    nofile    1048576
# memlock: use a high but bounded value — unlimited breaks Flatpak sandboxing
...
Explanation:
   -gc.maxreserved 128        Cap Unity's reserved GC heap to 128 MB;
                               prevents the mono runtime from grabbing a
                               large upfront slab and never returning it to the OS.
